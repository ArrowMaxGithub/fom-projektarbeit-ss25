...
public final class TodoListModel extends AbstractListModel<TodoElement>{
    ...
    }                                                           //Konstruktor zur Initialisierung der internen Liste

    @Override
    public int getSize() {
        return this.list.size();
    }                                                                   //Gibt die Anzahl der Elemente in der Todo Liste zurück

    @Override
    public TodoElement getElementAt(int index) {
        return this.list.get(index);
    }                                         //Rückgabe des Index eines Todo Listen Elementes

    public Iterator<TodoElement> iterator(){
        return this.list.iterator();
    }                                            //Iterator der ermöglicht die Elemente der Todo Liste zu durchlaufen
