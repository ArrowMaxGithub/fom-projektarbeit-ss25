...
public final class TodoElement{
    ...
    public String getHeader() {
        return header;
    }                                                                        //Rückgabe der Überschrift des Todo Elementes, wodurch diese zur Verfügung gestellt wird

    public String getMessage() {
        return message;
    }                                                                      //Rückgabe des Inhaltes des Todo Elementes, wodurch dieser zur Verfügung gestellt wird
}